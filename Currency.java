...
public final class ThaiBaht {
    private static final String[] SCALE_TH = { "ล้ำน", "สิบ", "ร้อย", "พัน", "หมื่น", "แสน","" };
    private static final String[] DIGIT_TH = { "ศูนย์", "หนึ่ง", "สอง", "สำม", "สี่", "ห้ำ","หก", "เจ็ด", "แปด", "เก้ำ" };
    private static final String[] SYMBOLS_TH = { "ลบ", "บำท", "ถ้วน", "สตำงค์" ,"ยี่","เอ็ด", ",", " ", "฿"};
    ...
    public String getText(double amount) {
        ...
        public String getText(float amoun);
        BigDecimal value = new BigDecimal(amount);
        this.valueText = getThaiBaht(value);
        return this.valueText;
     }
    ...
    private static String getThaiBaht(BigDecimal amount) {
        ...
        int digit = Integer.parseInt(String.valueOf(digits[digits.lengthb- index]));
     ...
     public static void main(String[] args) { // จุดทศนิยมปัดเป็นสองตำแหน่ง
         System.out.println(" value of 1234.5463 : " + new ThaiBaht().getText("1234.5463"));
        System.out.println(" value of -1,234.5463 : " + new ThaiBaht().getText("-1,234.5463"));
        System.out.println(" value of 1,234.5463 : " + new ThaiBaht().getText("1,234.5463"));
    }
}
